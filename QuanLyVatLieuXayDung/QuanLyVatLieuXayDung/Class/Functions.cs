...
namespace QuanLyBanHang.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=DESKTOP-H91SKDB\SQLEXPRESS;AttachDbFilename=" + Application.StartupPath + @"\QuanLyBanHang.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True";
            Con.Open();
